...
test_that("Alocação de UCs com períodos de coleta", {
  ...
  r_t_diarias <- do.call(alocar_ucs_mem, params_6)
  ...
  params_7 <- modifyList(params_6, list(agencias=params_6$agencias%>%mutate(dias_coleta_agencia_max=120)))
  r_t_max_agencia <- do.call(alocar_ucs_mem, params_7)
  ...
  r_t_min_entrevistadores <- do.call(alocar_ucs_mem, params_8)
