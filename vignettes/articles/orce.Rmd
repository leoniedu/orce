...
params:
  ...
  remuneracao_entrevistador: 1500
  uf_sigla_munic: "ES"
  viagens_munic: 1
  viagens_pnadc: 1
  viagens_cnefe: 1
  ...
  dias_coleta_agencia_max_munic: Inf
  dias_coleta_agencia_max_pnadc: Inf
...
estrategias_pnadc <- bind_rows(
  ...
  tibble(params_pnadc=list(modifyList(params_pnadc_0, 
                                      list( remuneracao_entrevistador=2500)
  )), 
  descricao='sem mínimo de entrevistador, remuneracao entrevistador 2500, sem custo fixo'))%>%
  #ungroup%>%slice(1)%>%
...
report_plans(estrategias_pnadc$resultado[[1]])
# 
estrategias_pnadc_sum%>%
  group_by(descricao)%>%
